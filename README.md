...
- Enfocarse en las características clave: El análisis mostró que la característica ‘V14’ es la más relevante para la detección de fraude, con un valor SHAP promedio global de 0.17, marcadamente superior a las demás características. Se recomienda realizar un análisis más profundo de qué representa esta característica y cómo se puede mejorar su recolección de datos o representación en el sistema. Además, dado que la cantidad de dinero transferido (‘Amount’) fue identificada como la característica menos importante, se podría reconsiderar el peso que se le asigna a esta variable en otros sistemas de decisión.